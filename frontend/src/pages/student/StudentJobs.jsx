      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-slate-200 rounded-xl mb-6 sm:mb-8">
          ...
          <div className="p-4 sm:p-6">
            ...
            {activeTab === 'mentorship' && (
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">Mentorship</h2>
                <FilterSection 
            ...
            {activeTab === 'resources' && (
              <div>
                <h2 className="text-xl sm:text-2xl font-bold text-slate-900 mb-4">Resources</h2>
                <FilterSection 
                  searchTerm={searchTerm} 
                  setSearchTerm={setSearchTerm}
                  onClearFilters={() => {
